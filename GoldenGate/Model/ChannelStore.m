                                ...
                                error:(NSError **)error
{
    ...
    SearchResult *channelResult = [self channelsForCategory:categoryId query:nil sort:sort start:start size:size text:nil error:error];
                                ...
                                error:(NSError **)error
{
    ...
    {
        [channels addObject:[searchCategory channelObject]];
    }
...
- (SearchResult *)channelsFromPublisher:(NSString *)publisher pageIndex:(NSUInteger)pageIndex pageSize:(NSUInteger)pageSize sortBy:(ProgramSortBy)sort error:(NSError **)error
{
    ...
    NSString *query = [NSString stringWithFormat:@"categoryMeta_publisher_text:\"%@\"", [publisher stringByReplacingOccurrencesOfString:@"\"" withString:@""]];
