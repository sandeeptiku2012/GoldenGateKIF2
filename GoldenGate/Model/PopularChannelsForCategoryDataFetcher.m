            ...
            errorHandler:(ErrorHandler)onError
{
    ...
    NSArray *popularChannels = [[VimondStore contentPanelStore] contentPanel:ContentPanelTypePopular forCategory:self.sourceObject error:&error];
    

    SearchResult *searchResult = [SearchResult new];
    searchResult.items = popularChannels;
    searchResult.totalCount = [popularChannels count];
