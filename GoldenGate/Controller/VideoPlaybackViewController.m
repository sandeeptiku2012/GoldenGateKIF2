...
- (void)createCloseButton
{
    ...
    self.navigationItem.leftBarButtonItem.accessibilityLabel = @"closeVideoPlay";
}
...
- (void)setupTrays
{
    ...
    self.playlistTray.isAccessibilityElement = YES;
    self.playlistTray.accessibilityLabel = @"Watching Next Tray";
}
...
- (void)viewDidLoad
{
    ...
    self.playerLayerView.accessibilityLabel=@"playerLayerView";
    self.playPauseButton.accessibilityLabel=@"PauseButton";
