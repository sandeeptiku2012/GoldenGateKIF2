...
- (void)viewDidLoad
{
    ...
    self.relatedContentView.accessibilityLabel = @"RelatedContent";
    self.videoTableView.accessibilityLabel = @"subCategoryTblView";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        videoTableCell.accessibilityLabel = @"videoTableCell";
    }
